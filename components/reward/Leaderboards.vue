    ...
    >
      <div class="bg-white flex flex-col w-full p-4 rounded-t-lg">
        ...
        <div
          ...
          class="my-8 hidden md:flex justify-between items-center"
        >
          <!-- 2nd award -->
          <div
        ...
        <div
          v-if="awards.length > 0"
          class="my-8 mx-10 flex flex-col space-y-4 md:hidden justify-between items-center"
        >
          <!-- first award -->
          <div
            class="w-full border border-[#E4669E] px-4 border-opacity-30 rounded-lg bg-[#FFFDFE] flex flex-col justify-center items-center content-center text-center py-12 space-y-2 text-xs relative"
            v-if="awards[0]"
          >
            <img
              :src="awards[0].employee.displayPicture"
          ...
          <!-- 2nd award -->
          <div
            class="w-full border border-[#E4669E] rounded-lg border-opacity-30 bg-[#FFFDFE] flex flex-col justify-center items-center content-center text-center py-8 px-4 space-y-2 text-xs relative"
            v-if="awards[1]"
          >
            <img
              :src="awards[1].employee.displayPicture"
          ...
          <!-- 3rd award -->
          <div
            class="w-full border rounded-lg px-4 border-[#E4669E] border-opacity-30 bg-[#FFFDFE] flex flex-col justify-center items-center content-center text-center py-4 space-y-2 text-xs relative"
            v-if="awards[2]"
          >
            <img
              :src="awards[2].employee.displayPicture"
    ...
    >
      <div class="bg-white flex flex-col w-full p-4 rounded-t-lg">
        ...
        >
          <!-- first award -->
          <div
            class="border w-full border-[#E4669E] px-4 border-opacity-30 rounded-lg bg-[#FFFDFE] flex flex-col justify-center items-center content-center text-center py-12 space-y-2 text-xs relative"
            v-if="awardsHr[0]"
          >
            <img
              :src="awardsHr[0].employee.displayPicture"
