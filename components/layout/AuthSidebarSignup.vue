<template>
  ...
  >
    <div
      class="bg-[url('~/assets/images/auth-bg.svg')] lg:fixed border-2 custom-border rounded-lg xl:ml-8 ml-10 px-10 mr-10 lg:mr-20 lg:w-[40%] py-10 flex flex-col justify-center items-center"
    >
      <!-- <h1>{{ sidebarTitle }}</h1>
      <p>{{ sidebarDescription }}</p> -->
      <h1 class="text-3xl text-[#182233] font-semibold">
        Let’s get Started!!!
      </h1>
      ...
      <p class="text-center text-lg text-[#585E6C] mt-4">
        Empower Your Team, Elevate Success: Building Stronger Bonds, One HR
        Platform at a Time
      </p>
    </div>
  </div>
