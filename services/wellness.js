...
export async function createTraining(formData) {
  ...
  const url = useRuntimeConfig(); // Make sure useRuntimeConfig is imported or defined
  const baseUrl = url.public.baseUrl;
  const endpoint = "/api/v1/wellness/create-training"; // Fix the typo here
  const token = localStorage.getItem("token");
...
export async function getTrainingsHr() {
  const url = useRuntimeConfig();
  const baseUrl = url.public.baseUrl;
  const endpoint = "/api/v1/wellness/all-trainings-hr";
  const token = localStorage.getItem("token");
...
export async function getEventsEmployee() {
  const url = useRuntimeConfig();
  const baseUrl = url.public.baseUrl;
  const endpoint = "/api/v1/wellness/all-events";
  const token = localStorage.getItem("token");
...
export async function getTrainingsEmployee() {
  const url = useRuntimeConfig();
  const baseUrl = url.public.baseUrl;
  const endpoint = "/api/v1/wellness/all-trainings";
  const token = localStorage.getItem("token");
